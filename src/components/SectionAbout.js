	...
	return (
     ...
     data-aos-duration="3000">
				...
				<div className='right-about'>
					...
					<p className='aboutText'>Haush Guitars tiene su origen en el año 2015. El luthier Nicolás Barrios tras años de capacitación y formación, desarrolló sus habilidades calibrando instrumentos de cuerda frotada para orquestas juveniles, asimismo estudió construcción de guitarras en la Asociación Argentina de Lutiers, y por último, trabajó en la fábrica de Guitarras Zagert (La Alpujarra, Fonseca) donde pegaba puentes y calibraba 25000 guitarras al año. Después de esta experiencia, armó su propio taller y comienza a construir instrumentos. Hoy en día, Haush Guitars trabaja con artistas de primer nivel que usan sus guitarras en shows masivos, grabaciones y ensayos, garantizando un verdadero prestigio a la marca. Los instrumentos son construidos a mano con total y entera dedicación en cada uno de ellos, con maderas macizas de excelentes prestaciones sonoras que influyen positivamente en el sonido final.</p>
				</div>
			</div>
			<hr width='100%' className='line'/>
		</div>
