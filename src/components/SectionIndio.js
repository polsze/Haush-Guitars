...
import Indio from '../images/indio.webp'
...
function SectionIndio() {
	return (
		<>
		<div className='sectionIndio-container'>
			...
			<h2 data-aos="fade-down" data-aos-duration="3000">Guitarra Acústica Signature <br/>Indio Solari</h2>
